...
/*$(function() {
    ...
    // 인증정보
    $parent.$("input[name=cert_type]").val("<?php echo $cert_type; ?>");
    $parent.$("input[name=mb_name]").val("<?php echo $user_name; ?>").attr("readonly", true);
    $parent.$("input[name=mb_hp]").val("<?php echo $phone_no; ?>").attr("readonly", true);
    $parent.$("input[name=cert_no]").val("<?php echo $md5_cert_no; ?>");
