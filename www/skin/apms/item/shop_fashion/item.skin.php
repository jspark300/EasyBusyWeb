...
<div class="item-head">
	<div class="row">
		...
		<div class="col-sm-6">
			...
			<?php } ?>
			<?php if ($it['it_model']) { ?>
				<tr><th scope="row">모델명</th><td><?php echo $it['it_model']; ?></td></tr>
			<?php } ?>
			<?php if ($it['it_1']) { ?>
				<tr><th scope="row">제품소재</th><td><?php echo $it['it_1']; ?></td></tr>
			<?php } ?>
			<?php if ($it['it_2']) { ?>
				<tr><th scope="row">색상</th><td><?php echo $it['it_2']; ?></td></tr>
			<?php } ?>
			<?php if ($it['it_3']) { ?>
				<tr><th scope="row">치수</th><td><?php echo $it['it_3']; ?></td></tr>
			<?php } ?>
			<?php if ($it['it_4']) { ?>
				<tr><th scope="row">제조연월</th><td><?php echo $it['it_4']; ?></td></tr>
			<?php } ?>
			...
			<?php } else { // 전화문의가 아닐 경우?>
				<?php if ($it['it_cust_price']) { ?>
					<tr><th scope="row">구매가격</th><td><?php echo display_price($it['it_cust_price']); ?></td></tr>
				<?php } // 시중가격 끝 ?>
...
<div class="btn-group btn-group-justified">
	<?php if($prev_href) { ?>
		<a class="btn btn-black btn-sm" href="<?php echo $prev_href;?>" title="<?php echo $prev_item;?>"><i class="fa fa-chevron-circle-left"></i> 이전</a>
	<?php } ?>
	<?php if($next_href) { ?>
		<a class="btn btn-black btn-sm" href="<?php echo $next_href;?>" title="<?php echo $next_item;?>"><i class="fa fa-chevron-circle-right"></i> 다음</a>
	<?php } ?>
	<?php if($edit_href) { ?>
		<a class="btn btn-black btn-sm" href="<?php echo $edit_href;?>"><i class="fa fa-plus"></i><span class="hidden-xs"> 수정</span></a>
	<?php } ?>
	<?php if ($write_href) { ?>
		<a class="btn btn-black btn-sm" href="<?php echo $write_href;?>"><i class="fa fa-upload"></i><span class="hidden-xs"> 등록</span></a>
	<?php } ?>
	<?php if($item_href) { ?>
		<a class="btn btn-black btn-sm" href="<?php echo $item_href;?>"><i class="fa fa-th-large"></i><span class="hidden-xs"> 관리</span></a>
	<?php } ?>
	<?php if($setup_href) { ?>
		<a class="btn btn-black btn-sm win_memo" href="<?php echo $setup_href;?>"><i class="fa fa-cogs"></i><span class="hidden-xs"> 스킨설정</span></a>
	<?php } ?>
	<a class="btn btn-black btn-sm" href="<?php echo $list_href;?>"><i class="fa fa-bars"></i> 목록</a>
</div>
